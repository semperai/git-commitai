            ...
            with patch('git_commitai.run_command') as mock_run:
                ...
                with tempfile.TemporaryDirectory() as tmpdir:
                    ...
                    for line in content.split('\n'):
                        if 'Please enter' in line or 'will be ignored' in line or 'On branch' in line:
                                    ...
                                    with patch('git_commitai.open_editor'):
                                        with patch('git_commitai.is_commit_message_empty', return_value=False):
                                            with patch('sys.argv', ['git-commitai', '-a']):
                                                ...
                                                mock_check.assert_called_once_with(amend=False, auto_stage=True)
