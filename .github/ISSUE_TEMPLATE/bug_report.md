...
**Environment:**
 ...
 - AI Provider: [e.g. OpenRouter, OpenAI, Local]
...
```
git-commitai/
├── git-commitai           # Main executable script
├── install.sh             # Unix/Linux installer
├── install.ps1            # Windows PowerShell installer
├── man/
│   └── git-commitai.1     # Man page documentation
├── tests/
│   ├── test_commit.py     # Commit functionality tests
...
- Update the man page (`man/git-commitai.1`) for user-facing changes
